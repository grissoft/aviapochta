...
//Format
$registry->set('format', new Format($registry));
...
//} else {
//	$action = new Action('ltkapi/common');
//}

require_once DIR_APPLICATION . 'controller/ltkapi/common.php';
...
$server = new SoapServer(HTTP_LTK . "index.php");
//Регистрируем класс обработчик
$server->setClass("LTKApiCommon");
//Запускаем сервер
$server->handle();
