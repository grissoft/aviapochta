  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button uacc="s_cff-b-1" type="submit" form="form-custom-field" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
          ...
          <table id="custom-field-value" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr id="custom-field-value-row<?php echo $custom_field_value_row; ?>">
                ...
                <td class="text-left"><button <?php echo !$custom_field_value_row 'uacc="s_cff-t1-b1"' : 'uac="s_cff-t1-b1"'; ?> onclick="$('#custom-field-value-row<?php echo $custom_field_value_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
              </tr>
            ...
            <tfoot>
              <tr>
                <td colspan="2"></td>
                <td class="text-left"><button uacc="s_cff-t1-b2" type="button" onclick="addCustomFieldValue();" data-toggle="tooltip" title="<?php echo $button_custom_field_value_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
              </tr>
            </tfoot>
          </table>
        </form>
...
function addCustomFieldValue() {
	...
	html += '  <td class="text-left"><button uac="s_cff-t1-b1" type="button" onclick="$(\'#custom-field-value-row' + custom_field_value_row + '\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
	html += '</tr>';	
