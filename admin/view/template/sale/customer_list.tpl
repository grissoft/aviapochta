...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a uacc="s_cfl-b-1" href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button uacc="s_cfl-b-2" type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-customer').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-3">
              ...
              <div class="form-group">
                <label class="control-label" for="input-external-id">Код клиента</label>
                <input type="text" name="filter_external_id" id="input-external-id" class="form-control" value="<?php echo $filter_external_id; ?>">
              </div>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left">Код клиента</td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($customer['customer_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php echo $customer['customer_number']; ?></td>
                  <td class="text-left"><?php echo $customer['external_id']; ?></td>
                  <td class="text-left"><?php echo $customer['name']; ?><br><small><?php echo $customer['partner_name']; ?></small></td>
                  ...
                  <td class="text-right">
                      ...
                      <div class="btn-group" uac<?php echo !$i ? 'c' : ''; ?>="s_cfl-t1-b4">
                    <a href="<?php echo $customer['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></div></td>
                </tr>
                <?php $i = true; ?>
                <?php } ?>
                <?php } else { ?>
