      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-sms" data-toggle="tab">TurboSMS</a></li>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <?php } ?>
              <fieldset>
                <legend>Посылки, упаковки</legend>
               <div class="form-group">
                <label class="col-sm-2 control-label" for="input-prefix">
                <span data-toggle="tooltip" data-container="#tab-general" title="Префикс для нумерации упаковок">Префикс</span>
                </label>
                <div class="col-sm-10">
                  <input type="text" name="config_prefix" value="<?php echo $config_prefix; ?>" placeholder="Префикс для нумерации упаковок" id="input-prefix" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-pack-status"><span data-toggle="tooltip" title="Статус новой упаковки при создании">Статус новой упаковки</span></label>
                  <div class="col-sm-10">
                    <select name="config_pack_status_id" id="input-pack-status" class="form-control">
                      <?php foreach ($pack_statuses as $pack_status) { ?>
                      <?php if ($pack_status['pack_status_id'] == $config_pack_status_id) { ?>
              ...
              <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-pack-status-2"><span data-toggle="tooltip" title="Статус упаковки после создания посылки">Статус упаковки после создания посылки</span></label>
                  <div class="col-sm-10">
                    <select name="config_pack_status_2_id" id="input-pack-status-2" class="form-control">
                      <?php foreach ($pack_statuses as $pack_status) { ?>
                      <?php if ($pack_status['pack_status_id'] == $config_pack_status_2_id) { ?>
                      <option value="<?php echo $pack_status['pack_status_id']; ?>" selected="selected"><?php echo $pack_status['name']; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $pack_status['pack_status_id']; ?>"><?php echo $pack_status['name']; ?></option>
                      <?php } ?>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-pack-status-3"><span data-toggle="tooltip" title="Статус упаковки после создания самолета">Статус упаковки после создания самолета</span></label>
                  <div class="col-sm-10">
                    <select name="config_pack_status_3_id" id="input-pack-status-3" class="form-control">
                      <?php foreach ($pack_statuses as $pack_status) { ?>
                      <?php if ($pack_status['pack_status_id'] == $config_pack_status_3_id) { ?>
                      <option value="<?php echo $pack_status['pack_status_id']; ?>" selected="selected"><?php echo $pack_status['name']; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $pack_status['pack_status_id']; ?>"><?php echo $pack_status['name']; ?></option>
                      <?php } ?>
            ...
            <div class="tab-pane" id="tab-sms">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-sms-login">Логин Turbosms:</label>
                <div class="col-sm-10">
                  <input type="text" name="config_sms[login]" value="<?php echo $config_sms_login; ?>" placeholder="Логин" id="input-sms-login" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-sms-password">Пароль Turbosms:</label>
                <div class="col-sm-10">
                  <input type="password" name="config_sms[password]" value="<?php echo $config_sms_password; ?>" placeholder="Пароль" id="input-sms-password" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-sms-sender"><span data-toggle="tooltip" title="Отправитель Turbosms<br>Максимальная длина - 11 символов<br>Можно использовать<br>буквы, цифры и знаки .,@">Отправитель Turbosms:</span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_sms[sender]" value="<?php echo $config_sms_sender; ?>" placeholder="Отправитель" id="input-sms-sender" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Уведомить нового пользователя о регистрации</label>
                <div class="col-sm-10">
                      <?php if($config_sms_customer) { ?>
                        <label class="radio-inline">
                          <input type="radio" name="config_sms_customer" value="1" checked="checked">Да
                        </label>
                        <label class="radio-inline">
                          <input type="radio" name="config_sms_customer" value="0">Нет
                        </label>
                      <?php } else { ?>
                        <label class="radio-inline">
                          <input type="radio" name="config_sms_customer" value="1">Да
                        </label>
                        <label class="radio-inline">
                          <input type="radio" name="config_sms_customer" value="0" checked="checked">Нет
                        </label>
                      <?php } ?>
                </div>
              </div>
              <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-sms-customer-text"><span data-toggle="tooltip" title="Шаблон текста о регистрации. Шаблоны подмены:<br>{customer_id} - код пользователя<br>{customer_name} - ФИО пользователя<br>{customer_firstname} - имя пользователя<br>{customer_lastname} - фамилия пользователя<br>{customer_login} - логин пользователя<br>{customer_password} - пароль пользователя">Шаблон текста о регистрации:</span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_sms_customer_text" value="<?php echo $config_sms_customer_text; ?>" placeholder="Регистрация" id="input-sms-customer-text" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Уведомить пользователя о изменениях посылкок</label>
                <div class="col-sm-10">
                      <?php if($config_sms_pack) { ?>
                        <label class="radio-inline">
                          <input type="radio" name="config_sms_pack" value="1" checked="checked">Да
                        </label>
                        <label class="radio-inline">
                          <input type="radio" name="config_sms_pack" value="0">Нет
                        </label>
                      <?php } else { ?>
                        <label class="radio-inline">
                          <input type="radio" name="config_sms_pack" value="1">Да
                        </label>
                        <label class="radio-inline">
                          <input type="radio" name="config_sms_pack" value="0" checked="checked">Нет
                        </label>
                      <?php } ?>
                </div>
              </div>
