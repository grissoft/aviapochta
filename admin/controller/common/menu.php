...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['customer_address'] = $this->url->link('sale/customer_address', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['category_group'] = $this->url->link('sale/category_group', 'token=' . $this->session->data['token'], 'SSL');
		$data['pack'] = $this->url->link('sale/pack', 'token=' . $this->session->data['token'], 'SSL');
        $data['parcel'] = $this->url->link('sale/parcel', 'token=' . $this->session->data['token'], 'SSL');
		$data['air'] = $this->url->link('sale/air', 'token=' . $this->session->data['token'], 'SSL');
		$data['order_status'] = $this->url->link('localisation/order_status', 'token=' . $this->session->data['token'], 'SSL');
		$data['pack_status'] = $this->url->link('localisation/pack_status', 'token=' . $this->session->data['token'], 'SSL');
		$data['parcel_status'] = $this->url->link('localisation/parcel_status', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['sklad'] = $this->url->link('localisation/sklad', 'token=' . $this->session->data['token'], 'SSL');
