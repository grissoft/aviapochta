...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        if (isset($this->request->post['config_prefix'])) {
            $data['config_prefix'] = $this->request->post['config_prefix'];
        } else {
            $data['config_prefix'] = $this->config->get('config_prefix');
        }
		...
		if (isset($this->request->post['config_pack_status_id'])) {
			$data['config_pack_status_id'] = $this->request->post['config_pack_status_id'];
		} else {
			$data['config_pack_status_id'] = $this->config->get('config_pack_status_id');
		}

        if (isset($this->request->post['config_pack_status_2_id'])) {
            $data['config_pack_status_2_id'] = $this->request->post['config_pack_status_2_id'];
        } else {
            $data['config_pack_status_2_id'] = $this->config->get('config_pack_status_2_id');
        }
        
        if (isset($this->request->post['config_pack_status_3_id'])) {
            $data['config_pack_status_3_id'] = $this->request->post['config_pack_status_3_id'];
        } else {
            $data['config_pack_status_3_id'] = $this->config->get('config_pack_status_3_id');
        }
		...
		if (isset($this->request->post['config_sms'])) {
			$config_sms = $this->request->post['config_sms'];

			$data['config_sms_login']       = $config_sms['login'];
			$data['config_sms_password']    = $config_sms['password'];
			$data['config_sms_sender']      = $config_sms['sender'];
			...
			$data['config_sms_login']       = '';
			$data['config_sms_password']    = '';
			$data['config_sms_sender']      = '';
		}
                
                $data['config_sms_customer']        = $this->config->get('config_sms_customer');
                $data['config_sms_customer_text']   = $this->config->get('config_sms_customer_text');
                $data['config_sms_pack']            = $this->config->get('config_sms_pack');
                
		if (isset($this->request->post['config_sms_customer'])) {
			$data['config_sms_customer']    = $this->request->post['config_sms_customer'];
		}
		if (isset($this->request->post['config_sms_customer_text'])) {
			$data['config_sms_customer_text']    = $this->request->post['config_sms_customer_text'];
		}
		if (isset($this->request->post['config_sms_pack'])) {
			$data['config_sms_pack']    = $this->request->post['config_sms_pack'];
		}
